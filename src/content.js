...
export const content = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "My work as a neuroscientist at NIMH was foundational to linking my spiritual development with the neuroplasticity of the EFT technique. The work allowed me to release emotional blocks and shine as a premium coach. Through your sessions, you'll use the tools to down-regulate anxiety, overwhelm, fear or self-doubt so you too can transform."
    ]
  },
